        ...
        <section class="leaflearn-hero">
            <div class="hero-copy">
                ...
                <div class="hero-actions">
                    <a class="leaflearn-button primary" href="~/Login.aspx" runat="server">Log in</a>
                    <a class="leaflearn-button secondary" href="~/Register.aspx" runat="server">Create account</a>
                </div>
